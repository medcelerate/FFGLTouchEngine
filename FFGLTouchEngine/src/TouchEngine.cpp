...
void FFGLTouchEngine::CreateIndividualParameter(const TouchObject<TELinkInfo>& linkInfo) {
...
void FFGLTouchEngine::CreateParametersFromGroup(const TouchObject<TELinkInfo>& linkInfo) {
